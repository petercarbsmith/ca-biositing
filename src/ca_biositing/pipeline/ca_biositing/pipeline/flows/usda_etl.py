...
def usda_etl_flow():
    ...
    # TODO: TEMPORARY BOOTSTRAP - Remove once commodity mapping system is complete
    # This ensures USDA commodities are seeded before extraction
    logger.info("[Bootstrap] Seeding USDA commodity mappings...")
    try:
        from ca_biositing.pipeline.utils.seed_usda_commodities import seed_usda_test_data
        seed_usda_test_data()
        logger.info("[Bootstrap] Commodity mappings ready")
    except Exception as e:
        logger.warning(f"[Bootstrap] Failed to seed commodities (non-fatal): {e}")
    # TODO: END TEMPORARY - Replace with proper commodity mapping management system
